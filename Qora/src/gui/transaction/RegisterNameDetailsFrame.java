...
public class RegisterNameDetailsFrame extends JFrame
{
	public RegisterNameDetailsFrame(RegisterNameTransaction nameRegistration)
	{
		...
		//TYPE
		detailGBC.gridy = 0;
		JLabel type = new JLabel("Register Name Transaction");
		...
		//LABEL REGISTRANT
		labelGBC.gridy = 4;
		JLabel registrantLabel = new JLabel("Registrant:");
		this.add(registrantLabel, labelGBC);
		
		//REGISTRANT
		detailGBC.gridy = 4;
		JTextField registrant = new JTextField(nameRegistration.getRegistrant().getAddress());
