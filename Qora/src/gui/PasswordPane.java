...
public class PasswordPane 
{
	public static String showUnlockWalletDialog()
	{
		...
		JLabel passwordLbl = new JLabel(lang.Translate("Enter wallet password")+":");
		...
		Object[] options = {
				lang.Translate("Unlock"),
				lang.Translate("Unlock for 2 minutes"),
